...
- **A goal biases the utility of a hand-authored action set.** Goals never script actions. They exist to carry what utility structurally cannot: persistent intent, action against immediate utility, and **intent that originated outside the actor**.
